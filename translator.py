...
class OpenRouterTranslator:
    ...
    def get_translation_prompt(self) -> str:
        """Возвращает оптимизированный промпт для литературного перевода больших блоков"""
        return """Вы эксперт литературного перевода с английского на русский. Переведите текст, сохранив авторский стиль и максимальное качество.

КЛЮЧЕВЫЕ ПРИНЦИПЫ:
• Адаптируйте идиомы и метафоры в естественный русский
• Сохраняйте авторскую интонацию, ритм и эмоциональное воздействие  
• Используйте современный живой русский язык
• Локализуйте культурные реалии по смыслу
• Переводите бизнес-термины устоявшимися эквивалентами
• Сохраняйте убедительность и энергичность оригинала

ВАЖНО: Для больших текстов сохраняйте последовательность стиля по всему фрагменту. Переведите весь текст полностью:"""
