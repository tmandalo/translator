...
class OpenRouterTranslator:
    ...
    def get_translation_prompt(self) -> str:
        """
        ИСПРАВЛЕНО: Сбалансированный промпт для точного литературного перевода.
        Сочетает требование сохранения стиля с запретом на обобщения.
        """
        return """
...
2.  **НАТИВНОСТЬ ДЛЯ ЧИТАТЕЛЯ:**
    ...
    -   **Адаптация идиом:** Адаптируйте идиомы, фразеологизмы и культурные реалии так, чтобы они были понятны русскоязычному читателю, сохраняя при этом первоначальный смысл и эффект.
